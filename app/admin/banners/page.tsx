          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">
                Banner Image * (Desktop layout or Default) <span className="text-[10px] text-gray-400 normal-case font-normal">(Recommended size: 1920 x 720 px)</span>
              </label>
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">
                Mobile Banner Image (Optional) <span className="text-[10px] text-gray-400 normal-case font-normal">(Recommended size: 800 x 1000 px)</span>
              </label>
