...
export default function AnnouncementBar({
  ...
  return (
    <div className="bg-[#7F1D1D] text-white text-[10px] sm:text-[11px] py-1.5 sm:py-2 border-b border-white/5 z-50 relative select-none">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center md:justify-between gap-2">
        {/* Left Side: Trust Badges */}
        <div className="flex flex-wrap items-center justify-center gap-x-4 sm:gap-x-6 gap-y-1.5 text-white/90">
        ...
        {/* Right Side: Quick Links (Hidden on mobile as they exist in mobile menu drawer) */}
